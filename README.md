...
<p align="center">
  <a href="https://github.com/jnMetaCode/agency-orchestrator">
    <strong>⭐ Изучите Agency Orchestrator — задействуйте 184 агента →</strong>
  </a>
</p>
...
Полный каталог 184 агентов: **[CATALOG.md](CATALOG.md)**. Сводка по отделам:
...
|--------|------------------|--------|
| **Этот проект** (agency-agents-ru) | 🎭 Русскоязычная библиотека персон | 184 готовых к использованию AI-эксперта, PR для рынка РФ welcome |
...
| [agency-agents-ko](https://github.com/jnMetaCode/agency-agents-ko) | 🇰🇷 Корейская версия | 184 переведённых агента |
| [agency-agents-pt-BR](https://github.com/jnMetaCode/agency-agents-pt-BR) | 🇧🇷 Бразильская версия | 184 переведённых агента |
...
| [agency-orchestrator](https://github.com/jnMetaCode/agency-orchestrator) | 🚀 Движок оркестрации | Одна фраза → 184 эксперта сотрудничают, **результат за минуты** (9 LLM / 6 бесплатных) |
...
**184 AI-агента, 17 инструментов, plug-and-play**
